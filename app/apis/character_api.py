...
character = ns.model('Character', {
    ...
    'scenario_idx' : fields.Integer(required=True, description='시나리오 고유 인덱스'),
...
class CharacterList(Resource):
    ...
    def get(self):
        ...
        if args['is_opened']:
            return CharacterModel.find_characters_by_scenario_title(args['scenario_title'])
        
        else:
            return CharacterModel.find_all_characters_by_scenario_title(args['scenario_title'])